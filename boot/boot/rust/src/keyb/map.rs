...
/// current keymap
pub static KEYMAP: fn(Key) -> u8 = default_keymap;
/// shift is pressed
pub static mut SHIFT: bool = false;
/// alt is pressed
pub static mut ALT: bool = false;
/// capslock on
pub static mut CAPSLOCK: bool = false;
